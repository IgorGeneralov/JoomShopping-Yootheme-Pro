...
?>
<h1 class="uk-heading uk-magin uk-margin-small">
...
<form action="<?php print $this->action ?>" method="post" name="loginForm" class="uk-form-horizontal uk-margin" enctype="multipart/form-data">
    ...
    <div class="tm-grid-expand uk-grid-margin uk-grid uk-grid-stack" uk-grid>
            ...
            ?>
                ...
                <div class="uk-card-footer">
                    <div class="uk-margin">
                        ...
                        <div class="uk-form-controls">
                            <input type="password" name="password" id="password" value="" class="uk-form-small el-input uk-input validate-password <?php if ($config_fields['password']['require']):?>required<?php endif?>">
        ...
        <div class="uk-margin-1-2@m">
            ...
            <div class="uk-margin-1-1 uk-margin-top uk-text-right">
                ...
                <input type="submit" name="next" value="<?php print JText::_('JSHOP_SAVE')?>" class="uk-button-primary uk-button" />
            </div>
        </div>
    </div>
</form>